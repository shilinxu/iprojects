...
public:	
	void SetRgnBtn(BOOL bRgnBtn);
	void SetButtonWidth(int nWidth);
	void SetButtonColor(COLORREF color);
	void SetWidthButton(BOOL bWidthBtn = TRUE);
	void SetColorButton(BOOL bColorBtn = TRUE);
	void SetActionButton(BOOL bAction = TRUE);
	BOOL IsSelected();
	void SetCheckButton(BOOL bCheckBtn = TRUE);
	void Set3StateButton(BOOL b3State = TRUE);
	...
	DWORD SetBitmaps(int nBitmap, COLORREF crTransColor);
	DWORD SetBitmaps(HBITMAP hBitmap, COLORREF crTransColor);
