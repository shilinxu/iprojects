...
public:
	...
	inline void ResetGraphics()
	{
		...
		m_pGrpBottom->SetSmoothingMode(SmoothingModeAntiAlias);// SmoothingModeHighQuality, SmoothingModeHighSpeed
		m_pGrpBottom->SetCompositingQuality(CompositingQualityHighQuality);
	}
